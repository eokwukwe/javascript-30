...
const fiftenHundred = inventors.filter(
  inventor => inventor.year >= 1500 && inventor.year <= 1599
);

console.table(fiftenHundred);
...
const totalYearsLived = inventors.reduce((totalYear, inventor) => {
...
const sortAlphabeticallyByLastName = people.sort((a, b) => {
  const [aLast, aFirst] = a.split(',');
  const [bLast, bFirst] = b.split(',');
  return aLast > bLast ? 1 : -1;
});
console.log(sortAlphabeticallyByLastName);
